...
author: "Léo Mignot (& Émilien Schultz)"
date: 2025-12-08
#format: pptx
format: 
    revealjs:
...
## Meme/20
![](img/paintsur20.png){style="display:block; margin:auto;"}
...
![](img/notime.png){style="display:block; margin:auto;"}
...
Dépôt Github : [https://github.com/leomignot/DataSHS_initiation_python](https://github.com/leomignot/DataSHS_initiation_python)
...
## Nous : notebooks Jupyter {.smaller}
